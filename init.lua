...
vim.keymap.set('', '<C-Up>', '<C-W>k', { silent = true })
vim.keymap.set('', '<C-Down>', '<C-W>j', { silent = true })
vim.keymap.set('', '<C-Left>', '<C-W>h', { silent = true })
vim.keymap.set('', '<C-Right>', '<C-W>l', { silent = true })
...
require('nvim-treesitter.configs').setup {
  ...
  ensure_installed = { 'c', 'cpp', 'go', 'lua', 'python', 'rust', 'ruby', 'tsx', 'javascript', 'typescript', 'vimdoc',
    'vim' },
